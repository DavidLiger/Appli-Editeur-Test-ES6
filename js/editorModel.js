...
class Model{
  ...
  getTests(){
    return this.XMLHttpRequest("POST","../obj_mvc_ts2/ajaxOptionsSelectTests.php","write","JSON");
  }
  getTestNom(){
    return testNom;
  }
  ...
  dataCutter(){
    ...
    dataJSON = this.XMLHttpRequest("POST","../obj_mvc_ts2/ajaxGetTest.php",data,"JSON");
    testId = dataJSON[0];
    dataBrut = dataJSON[1];
